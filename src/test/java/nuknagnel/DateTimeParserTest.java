...
public class DateTimeParserTest {
    ...
    public void parseDate_invalidFormat_throws() {
        InvalidInputException exception = assertThrows(InvalidInputException.class,
                () -> DateTimeParser.parseDate("02-01-2024"));
    ...
    public void parseDateTime_invalidFormat_throws() {
        InvalidInputException exception = assertThrows(InvalidInputException.class,
                () -> DateTimeParser.parseDateTime("2024/02/01 13:45"));

        assertEquals("Please use yyyy-mm-dd HHmm or yyyy-mm-dd HH:mm for date-time.",
