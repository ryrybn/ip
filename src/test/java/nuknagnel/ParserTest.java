...
public class ParserTest {
    ...
    public void parse_eventCommand_success() {
        ...
        assertEquals("[E][ ] meeting (from: Feb 3 2024 12:00 to: Feb 3 2024 13:00)",
                command.getTask().toString());
    }

    @Test
    public void parse_missingIndex_throws() {
        InvalidInputException exception = assertThrows(InvalidInputException.class, () -> Parser.parse("mark"));
    ...
    public void parse_invalidIndex_throws() {
        InvalidInputException exception = assertThrows(InvalidInputException.class, () -> Parser.parse("delete 0"));
    ...
    public void parse_missingTodoDescription_throws() {
        InvalidInputException exception = assertThrows(InvalidInputException.class, () -> Parser.parse("todo "));
